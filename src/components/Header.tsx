...
const Header: React.FC<HeaderProps> = ({ onSearch, totalListed }) => {
  return (
    <header className="py-12 px-6 max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-end gap-8">
      <div className="flex-1">
        <div className="flex items-center gap-3 mb-4">
          ...
          <span className="text-secondary text-lg mt-2 opacity-50">{totalListed} Listed</span>
        </div>
        <p className="max-w-2xl text-text-secondary leading-relaxed">
          Every top striker in the World Cup 2026 has their own pump.fun coin. All coins are independently deployed on Solana via pump.fun and are not affiliated with FIFA, the World Cup, or the players.
        </p>
      </div>
